...
parser.add_argument('--lr', '--learning-rate', default=4.0, type=float,
                    metavar='LR', help='initial learning rate', dest='lr')

#TODO CHECK MOMENTUM, NOT LISTED IN PAPER
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = PixPro(
        ...
        args.pixpro_mom, args.ppm_layers, args.ppm_gamma
    )
    ...
    train_dataset = ContrastData(
        args.data, space_tfs, view1_color_tfs, view2_color_tfs
    )
...
def train(train_loader, model, criterion, optimizer, scaler, epoch, args):
    ...
    for i, batch in enumerate(train_loader):
        ...
        if args.gpu is not None:
            ...
            view1_grid = view1_grid.cuda(args.gpu, non_blocking=True)
